...
SPARKAI_APP_ID = 'c3dcaff0'
SPARKAI_API_SECRET = 'OTZhZjQyOGIyYzAwZDQ4ZDBhOGVmMWMy'
SPARKAI_API_KEY = '6f3d5b203c61eee7d3176acea7ee7aa5'
...
if __name__ == "__main__":
    ...
    for index, data in tqdm(enumerate(test_data)):
        ...
        for i in range(retry_count):
            try:
                res = get_completions(PROMPT_EXTRACT.format(content=test_data['chat_text']))
